...
WORK = Path('/Users/naru/Walkers_naru/03_projects/合同会社どうぶつとひと出版／Aメディカル制作所/minutes/2026-06-01_初回ヒアリングMTG')
PARTS = WORK / 'parts'
SEG = 600          # 分割秒（Phase 3 と一致）
N_PARTS = 6        # 46分→5パート想定。多めでも存在チェックで空振りするだけ
...
print(f"除去された連続反復 {len(removed)}件")
