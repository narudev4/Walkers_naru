...
WORK = Path('/Users/naru/Walkers_naru/03_projects/落合コーポレーション/minutes/2026-07-31_第7回MTG')
PARTS = WORK / 'parts'
SEG = 600          # 分割秒（Phase 3 と一致）
N_PARTS = 5        # 47.8分 → 5パート
...
print(f"反復除去: {len(removed)}件")
for st, cnt, t in removed[:5]:
    print(f"  {hms(st)} x{cnt} {t}")
